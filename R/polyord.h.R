...
PolyOrdOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "PolyOrdOptions",
    ...
    public = list(
        initialize = function(
            ...
            private$..colorScheme <- jmvcore::OptionList$new(
                ...
                options = list("tableau","rdbulite","rdylgn","piyg","prgn","pastel","dark2","set2","viridis","plasma"),
                default = "tableau")
...
PolyOrdResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "PolyOrdResults",
    ...
    public = list(
        initialize = function(options) {
            super$initialize(
                options = options,
                name    = "",
                title   = "Multiple Ordinal/Nominal Plots")
...
PolyOrdBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "PolyOrdBase",
...
#' Multiple Ordinal/Nominal Plots
#'
#' @param data  A data frame.
#' @param vars  Factor variables to plot.
#' @param ...   Additional options (see \code{PolyOrdOptions}).
#' @return A results object.
#' @export
PolyOrd <- function(data, vars, ...) {
    if (!requireNamespace("jmvcore", quietly=TRUE))
        stop("PolyOrd requires jmvcore")
