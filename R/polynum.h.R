polyNumOptions <- R6::R6Class(
    ...
    public = list(
        initialize = function(
            ...
            private$..plotType    <- jmvcore::OptionList$new(
                "plotType", plotType,
                options = list("box","violin","strip","histogram","ridge","barcode","raincloud"),
                default = "box")
            ...
            private$..ridgeOverlap <- jmvcore::OptionInteger$new("ridgeOverlap", ridgeOverlap, min=0L, max=200L, default=50L)
            private$..lineWidth    <- jmvcore::OptionInteger$new("lineWidth",   lineWidth,   min=1L,   max=5L,   default=2L)
            private$..colorScheme  <- jmvcore::OptionList$new(
                "colorScheme", colorScheme,
                options = list("viridis","plasma","mako","rocket","turbo","dark","pastel","warm","cold"),
                default = "viridis")
            ...
            self$.addOption(private$..ridgeOverlap)
    ...
    active = list(
        ...
        ridgeOverlap = function() private$..ridgeOverlap$value,
